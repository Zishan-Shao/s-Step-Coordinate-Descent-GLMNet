...
updateBeta <- function(A, b, lambda, alpha, Beta, m, n, tol, maxit) {
  ...
  plot(beta_differences, type='o', pch=9, col='red', xlab='Iteration', ylab='Difference from Optimal Beta')
  title('RLog Convergence')
...
Beta <- updateBeta(X_train, y_train, lambda, alpha, Beta, length(y_train), ncol(X), 1e-10, 2000)
